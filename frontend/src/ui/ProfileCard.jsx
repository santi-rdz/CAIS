...
export default function ProfileCard({ isExpanded }) {
  ...
  return (
    <div ref={ref} className="relative mt-auto" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      {isOpen && (
        <>
      ...
      >
        <div className="flex items-center">
          ...
          <div className={`flex flex-col transition-all duration-300 ease-in-out ${isExpanded ? 'ml-2 w-24' : 'w-0'}`}>
