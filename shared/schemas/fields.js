...
export const personaBaseFields = {
  nombre: z.string().min(2, 'El nombre es requerido').max(255).refine(noHtml, noHtmlMessage),
  apellidos: z.string().min(2, 'Los apellidos son requeridos').max(255).refine(noHtml, noHtmlMessage),
