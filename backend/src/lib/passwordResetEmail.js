...
<div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); font-family: Arial, sans-serif;">
  ...
  <div style="padding: 40px;">
    <p style="margin: 0 0 20px; color: #1f2937; font-size: 16px; line-height: 1.6;">
      Hola <strong style="color: #166534;">${name || 'Usuario'}</strong>,
    </p>

    <p style="margin: 0 0 30px; color: #4b5563; font-size: 16px; line-height: 1.6;">
      Hemos recibido una solicitud para restablecer la contraseña de tu cuenta en CAIS. Haz clic en el siguiente botón para crear una nueva contraseña:
    </p>
