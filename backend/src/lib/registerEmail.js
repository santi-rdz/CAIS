...
<head>
  ...
  <title>Completa tu registro — CAIS</title>
          ...
          <tr>
            <td style="padding: 36px 48px 0 48px;">
              ...
              <p style="margin: 0 0 14px 0; font-size: 15px; line-height: 1.75; color: #374151;">
                Hola <span style="font-weight: 600; color: #111827;">${name}</span>,
              </p>

              <p style="margin: 0 0 32px 0; font-size: 15px; line-height: 1.75; color: #374151;">
                Has sido invitado a unirte a la plataforma CAIS. Configura tu cuenta con el siguiente enlace para comenzar.
              </p>
              ...
              <!-- Expiry note — departmental stripe signature -->
                ...
                <tr>
                  <td style="border-left: 3px solid #166534; padding: 11px 16px; background-color: #F9FAFB; border-radius: 0 4px 4px 0;">
                    <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #6B7280;">
                      Este enlace es válido por <span style="font-weight: 500; color: #374151;">48 horas</span>. Si no esperabas esta invitación, puedes ignorar este correo.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding: 20px 48px 32px 48px;">
              <p style="margin: 0; font-size: 12px; line-height: 1.6; color: #9CA3AF;">
                &copy; ${year} Centro de Atención Integral de Salud &middot; Este correo fue enviado a ${email}
              </p>
            </td>
          </tr>
